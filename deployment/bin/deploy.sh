...
if [ ! -d $PROJECT_DIR"/.git" ]; then
  GIT_SSH_COMMAND='ssh -i /Users/diego/.ssh/id_ed25519 -o IdentitiesOnly=yes' git clone git@github.com:diegoldev/devops-with-laravel.git .
else
  GIT_SSH_COMMAND='ssh -i /Users/diego/.ssh/id_ed25519 -o IdentitiesOnly=yes' git pull
fi
